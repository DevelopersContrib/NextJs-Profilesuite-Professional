/**
 * Demo cards for “Explore featured profiles” when `GET_PROFILES` is missing or the request fails,
 * unless `NEXT_PUBLIC_PROFILE_MOCK=0`. Shaped like live API items: id, name, intro, image, domain, socials.
 * When `GET_PROFILES` is set and works, the API list is used instead.
 *
